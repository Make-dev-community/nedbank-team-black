...
export default function Home() {
  return (
    ...
    <div className="flex items-center gap-x-3">
        <span className="px-3 py-1 text-xs text-blue-600 bg-blue-100 rounded-full dark:bg-gray-800 dark:text-blue-400">5 Items</span>
    </div>
                    ...
                    <table className="min-w-full divide-y divide-gray-200 dark:divide-gray-700">
                        <thead className="bg-gray-50 dark:bg-gray-800">
                            <tr>
                                ...
                                <th scope="col" className="px-4 py-3.5 text-sm font-normal text-left rtl:text-right text-gray-500 dark:text-gray-200"></th>
                            ...
                            <tr>
                                <td className="px-4 py-4 text-sm font-medium text-gray-700 whitespace-nowrap">
                                    <div className="inline-flex items-center gap-x-3">
                                        ...
                                        <div className="flex items-center gap-x-2">
                                            ...
                                            <div>
                                                <h2 className="font-medium text-gray-800 dark:text-white ">Sasko bread</h2>
                                ...
                                <td className="px-12 py-4 text-sm font-medium text-gray-700 whitespace-nowrap">
                                    <div className="inline-flex items-center px-3 py-1 rounded-full gap-x-2 bg-emerald-100/60 dark:bg-gray-800">
                                        ...
                                        <h2 className="text-sm font-normal text-emerald-500">R 40</h2>
                                    </div>
                                </td>
                                <td className="px-4 py-4 text-sm text-gray-500 dark:text-gray-300 whitespace-nowrap">x1</td>
                            ...
                            <tr>
                                <td className="px-4 py-4 text-sm font-medium text-gray-700 whitespace-nowrap">
                                    <div className="inline-flex items-center gap-x-3">
                                        ...
                                        <div className="flex items-center gap-x-2">
                                            ...
                                            <div>
                                                <h2 className="font-medium text-gray-800 dark:text-white ">Biltong</h2>
                                ...
                                <td className="px-12 py-4 text-sm font-medium text-gray-700 whitespace-nowrap">
                                    <div className="inline-flex items-center px-3 py-1 rounded-full gap-x-2 bg-emerald-100/60 dark:bg-gray-800">
                                        ...
                                        <h2 className="text-sm font-normal text-emerald-500">R23</h2>
                                    </div>
                                </td>
                                <td className="px-4 py-4 text-sm text-gray-500 dark:text-gray-300 whitespace-nowrap">x1</td>
                            ...
                            <tr>
                                <td className="px-4 py-4 text-sm font-medium text-gray-700 whitespace-nowrap">
                                    <div className="inline-flex items-center gap-x-3">
                                        ...
                                        <div className="flex items-center gap-x-2">
                                            ...
                                            <div>
                                                <h2 className="font-medium text-gray-800 dark:text-white ">Soda</h2>
                                ...
                                <td className="px-12 py-4 text-sm font-medium text-gray-700 whitespace-nowrap">
                                    <div className="inline-flex items-center px-3 py-1 rounded-full gap-x-2 bg-emerald-100/60 dark:bg-gray-800">
                                        ...
                                        <h2 className="text-sm font-normal text-emerald-500">R 30</h2>
                                    </div>
                                </td>
                                <td className="px-4 py-4 text-sm text-gray-500 dark:text-gray-300 whitespace-nowrap">x3</td>
                            ...
                            <tr>
                                <td className="px-4 py-4 text-sm font-medium text-gray-700 whitespace-nowrap">
                                    <div className="inline-flex items-center gap-x-3">
                                        ...
                                        <div className="flex items-center gap-x-2">
                                            ...
                                            <div>
                                                <h2 className="font-medium text-gray-800 dark:text-white ">Chips</h2>
                                ...
                                <td className="px-12 py-4 text-sm font-medium text-gray-700 whitespace-nowrap">
                                    <div className="inline-flex items-center px-3 py-1 rounded-full gap-x-2 bg-emerald-100/60 dark:bg-gray-800">
                                        ...
                                        <h2 className="text-sm font-normal text-emerald-500">R 32</h2>
                                    </div>
                                </td>
                                <td className="px-4 py-4 text-sm text-gray-500 dark:text-gray-300 whitespace-nowrap">x1</td>
                            ...
                            <tr>
                                <td className="px-4 py-4 text-sm font-medium text-gray-700 whitespace-nowrap">
                                    <div className="inline-flex items-center gap-x-3">
                                        ...
                                        <div className="flex items-center gap-x-2">
                                            ...
                                            <div>
                                                <h2 className="font-medium text-gray-800 dark:text-white ">Salt</h2>
                                ...
                                <td className="px-12 py-4 text-sm font-medium text-gray-700 whitespace-nowrap">
                                    <div className="inline-flex items-center px-3 py-1 rounded-full gap-x-2 bg-emerald-100/60 dark:bg-gray-800">
                                        ...
                                        <h2 className="text-sm font-normal text-emerald-500">R 10</h2>
                                    </div>
                                </td>
                                <td className="px-4 py-4 text-sm text-gray-500 dark:text-gray-300 whitespace-nowrap">x1</td>
